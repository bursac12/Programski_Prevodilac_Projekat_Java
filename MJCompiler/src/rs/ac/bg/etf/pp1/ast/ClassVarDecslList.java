...
public class ClassVarDecslList extends ClassVarDeclList {

    private ClassVarDeclList ClassVarDeclList;
    private VarDecl VarDecl;

    public ClassVarDecslList (ClassVarDeclList ClassVarDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassVarDecslList(\n");
