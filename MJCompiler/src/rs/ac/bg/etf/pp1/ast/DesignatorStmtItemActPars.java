...
public class DesignatorStmtItemActPars extends DesignatorStatementItem {

    private Designator Designator;
    private ActParsOpt ActParsOpt;

    public DesignatorStmtItemActPars (Designator Designator, ActParsOpt ActParsOpt) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStmtItemActPars(\n");
