...
public class MethodVarDeclListItems extends MethodVarDeclList {

    private MethodVarDeclList MethodVarDeclList;
    private VarDecl VarDecl;

    public MethodVarDeclListItems (MethodVarDeclList MethodVarDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodVarDeclListItems(\n");
